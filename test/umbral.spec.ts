...
describe('End-to-end tests', () => {
    ...
    it('Basic example with 1 OC, 2 matched users', async function () {
        ...
        const encryptedDataA = _umbral.encryptData(randId, {
            perpId,
            userId
        }, [ocKeyPair.publicKey], userKeyPair.privateKey);
        userId = userId + userId;

        const encryptedDataB = _umbral.encryptData(randId, {
            perpId,
            userId
        }, [ocKeyPair.publicKey], userKeyPair.privateKey);
    ...
    it('Basic example with 3 matches', async function () {
        ...
        const encryptedDataA = _umbral.encryptData(randId, {
            perpId,
            userId
        }, [ocKeyPair.publicKey], userKeyPairA.privateKey);
        userId = userId + userId;
        const encryptedDataB = _umbral.encryptData(randId, {
            perpId,
            userId
        }, [ocKeyPair.publicKey], userKeyPairB.privateKey);
        userId = userId + userId;
        const encryptedDataC = _umbral.encryptData(randId, {
            perpId,
            userId
        }, [ocKeyPair.publicKey], userKeyPairC.privateKey);
...
describe('Error cases', () => {
    ...
    it('Incorrect match found', async function () {
        ...
        const encryptedDataA = _umbral.encryptData(randIdA, {
            perpId,
            userId
        }, [ocKeyPair.publicKey], userKeyPair.privateKey);
        userId = userId + userId;
        const encryptedDataB = _umbral.encryptData(randIdB, {
            perpId,
            userId
        }, [ocKeyPair.publicKey], userKeyPair.privateKey);
    ...
    it('2 shares can decrypt, 1 cannot', async function () {
        ...
        userId = userId + userId;
        const encryptedDataC = _umbral.encryptData(performOPRF(perpId + perpId), {
            perpId,
            userId
        }, [ocKeyPair.publicKey], userKeyPairC.privateKey);
...
describe('User editing', () => {
    ...
    it('Updating user record', async function () {
        ...
        const randIdA: Uint8Array = performOPRF(perpId);
        const encryptedDataA: IEncryptedData[] = _umbral.encryptData(randIdA, {
            perpId,
            userId
        }, [ocKeyPair.publicKey], userKeyPair.privateKey);
