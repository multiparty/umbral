...
(function (CryptoService) {
    ...
    CryptoService.init = init;
    function hash(input) {
        return input;
    }
    CryptoService.hash = hash;
    /**
     ...
     */
    function encryptData(randId, hashedUserName, publicKeys) {
        if (randId === '' || hashedUserName === '' || publicKeys.length < 1) {
            return undefined;
        }
        this.sodium;
        // console.log(this.sodium);
    }
    CryptoService.encryptData = encryptData;
