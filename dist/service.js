...
(function (CryptoService) {
    ...
    CryptoService.hello = hello;
})(CryptoService = exports.CryptoService || (exports.CryptoService = {}));
...
//  *
//  * part of the { **crypto** => [client](clientdataservice.html) => [server](apicontroller.html) => [database](record.html) } data flow
//  *
//  * Persistence | Context
//  * --- | ---
...
//  *
//  * Sensitive data starts being processed by the application starting with crypto service, which takes in plain text data and turns it into encrypted data, to be stored by the [client side data storage service](clientdataservice.html)
//  */
// @Injectable()
...
//       plainText.k,
//       this.sodium.to_base64(plainText.recordKey),
//     );
//     const msg: IMessage = {
//       U: plainText.U,
//       s: plainText.s,
...
//     // tslint:disable-next-line
//     const kDemo: string =
//       'MjQ2LDIyLDE2NiwyMzUsODEsMTgzLDIzMSwyMTgsMTE2LDUzLDEzNCwyNyw0Miw1OSwxMDQsMTkyLDExOCwxMCwzNCwyMj';
//     const pHat: Uint8Array = this.sodium
//       .crypto_hash(perpId + kDemo)
//       .slice(0, 32);
//     // tslint:disable-next-line
//     const a: bigInt.BigInteger = bigInt(
//       this.bytesToString(
//         this.sodium.crypto_kdf_derive_from_key(32, 1, 'derivation', pHat),
//       ),
//     );
//     const k: Uint8Array = this.sodium.crypto_kdf_derive_from_key(
//       32,
//       2,
//       'derivation',
//       pHat,
//     );
//     const pi: string = this.sodium.to_base64(
//       this.sodium.crypto_kdf_derive_from_key(32, 3, 'derivation', pHat),
//     );
//     const U: bigInt.BigInteger = bigInt(
//       this.sodium.to_hex(this.sodium.crypto_hash(userName).slice(0, 32)),
//       this.HEX,
//     );
...
//     let coordA: ICoord = this.createCoord(
//       messages[0],
//       this.dataSubmissions[0].pi,
//     );
//     let coordB: ICoord = this.createCoord(
//       messages[1],
//       this.dataSubmissions[1].pi,
//     );
...
//     const decryptedRecords: IRecord[] = this.decryptRecords(
//       messages,
//       [data[0].eRecord, data[1].eRecord],
//       k,
//     );
//     return {
//       decryptedRecords,
...
//     const nonce: Uint8Array = this.sodium.randombytes_buf(
//       this.sodium.crypto_box_NONCEBYTES,
//     );
//     const cY: Uint8Array = this.sodium.crypto_box_easy(
//       JSON.stringify(message),
//       nonce,
//       this.ocKeys.publicKey,
//       this.userKeys.privateKey,
//     );
//     const encrypted: string =
//       this.sodium.to_base64(cY) + '$' + this.sodium.to_base64(nonce);
//     return encrypted;
//   }
//   /**
...
//     const encrypted: string =
//       this.sodium.to_base64(cT) + '$' + this.sodium.to_base64(nonce);
//     return encrypted;
//   }
//   /**
...
//     for (const i in data) {
//       const recordKey: Uint8Array = this.symmetricDecrypt(
//         k,
//         data[i].eRecordKey,
//       );
//       const decryptedRecord: Uint8Array = this.symmetricDecrypt(
//         this.sodium.from_base64(recordKey),
//         eRecords[i],
//       );
//       const dStr: string = new encoding.TextDecoder('utf-8').decode(
//         decryptedRecord,
//       );
...
//     const decrypted: Uint8Array = this.sodium.crypto_secretbox_open_easy(
//       cT,
//       nonce,
//       key,
//     );
...
//         this.ocKeys.privateKey,
//       );
//       const msgObj: IMessage = JSON.parse(
//         new encoding.TextDecoder('utf-8').decode(msg),
//       );
